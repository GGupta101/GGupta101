...
//Description: Matrix multiplication for 2x2 arrays where there is one thread per row in the 
...
void *go(void *);
#define N 2   //Row value of Matrix A and Matrix C
#define M 2   //Row value of Matrix B and Column value of Matrix A
#define L 2   //Column value of Matrix B and Matrix C
