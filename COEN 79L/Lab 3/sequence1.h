//Name: Gagan Gupta
//Date: 01/24/20
//Assignment: Lab 3 Header File
//Description: Header file for the sequence Class
...
//Macroguard for the Header file
...
namespace coen79_lab3 {
    ...
    private:
        //Variables and data structures to use with the fuctions in public
        value_type seq[CAPACITY];
        size_type items;
        int iterator;
    };
